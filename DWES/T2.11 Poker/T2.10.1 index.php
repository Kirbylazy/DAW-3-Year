...
require_once "T2.10.1 repartir.php";
...
?>
    ...
    <table border="1" cellpadding="5">
        <?php for ($j = 0; $j < count($juego); $j++): ?>
            <tr><th>Jugador <?= $j + 1 ?></th><th>1</th><th>2</th><th>3</th><th>4</th><th>5</th></tr>
            <tr>
                <th>Cartas</th>
                <!-- Usamos un ciclo for para mostrar todas las cartas -->
                <?php for ($i = 0; $i <= 4; $i++): ?>
                    <th><img src="Baraja/<?= $juego[$j][$i]["valor"] ?><?= $juego[$j][$i]["palo"] ?>.svg" alt="carta" width="100"></th>
                <?php endfor; ?>
            </tr>
            <?php endfor; ?>
    </table>
    ...
    <h2>Cartas a Descartar</h2>
        ...
        <form method="post" action="">
            ...
            <label for="d2"><br><br>Segunda Carta (0 para no descartar)</label>
